      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-14 max-w-2xl sm:mb-16">
          ...
          <p className="mt-5 max-w-xl text-sm leading-6 text-text-secondary sm:text-base">
            A selection of projects I've built while learning frontend
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="inline-flex items-center gap-2 rounded-full border border-border bg-surface px-3 py-1.5 text-[10px] font-medium uppercase tracking-[0.16em] text-text-secondary">
                    <span
                      aria-hidden="true"
                ...
                <h3 className="mt-4 font-display text-3xl text-text-primary sm:text-4xl">
                  {project.title}
                </h3>
              </div>
